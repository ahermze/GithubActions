[![Run App Hermsen, Alex](https://github.com/ahermze/GithubActions/actions/workflows/run-app.yml/badge.svg)](https://github.com/ahermze/GithubActions/actions/workflows/run-app.yml)
